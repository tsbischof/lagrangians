...
class ChoiceWindow(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.imageView.setGeometry(QtCore.QRect(0,0,1000,50))

        self.likeButton = QtGui.QPushButton(self.centralWidget)
        self.likeButton.setText("Like")
        self.likeButton.setGeometry(QtCore.QRect(0,50,500,50))
        ...
        self.dislikeButton.setGeometry(QtCore.QRect(500,50,500,50))
